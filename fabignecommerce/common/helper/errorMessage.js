const ERROR_MESSAGE = {
  ...
  HTTP_PROCESSING:
    "Server has received and is processing the request, but no response is available yet.", // RFC2518
  ...
  HTTP_ALREADY_REPORTED:
    "Used inside a response element to avoid repeatedly enumerating the internal members of multiple bindings to the same collection.", // RFC5842
  HTTP_IM_USED:
